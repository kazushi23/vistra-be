...
class FileService extends BaseService {
     ...
     */
    async getNextAvailableName(originalName, queryRunner) {
        ...
        const basePattern = new RegExp(`^${this.escapeRegex(nameWithoutExt)}(?:\\((\\d+)\\))?${this.escapeRegex(ext)}$`);
        ...
        while (attempt < this.MAX_RETRIES) {
            ...
            try {
                ...
                for (const metadata of metadatas) {
                    ...
                    const uniqueName = await this.getNextAvailableName(metadata.basename, // Original name (e.g., "document.pdf")
                    queryRunner);
                ...
                const isRetryable = error.code === '40001' || // Serialization failure (PostgreSQL)
